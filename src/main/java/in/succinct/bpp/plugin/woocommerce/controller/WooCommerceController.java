package in.succinct.bpp.plugin.woocommerce.controller;
    ...
    public View hook() throws Exception{
        ...
        if (ObjectUtil.equals(getPath().getHeader("X-WC-Webhook-Topic"),"order.updated")){
            ...
            mac.init(new SecretKeySpec(
                    Config.instance().getProperty("in.succinct.bpp.plugin.woocommerce.hmac.key").getBytes(StandardCharsets.UTF_8),
                    "HmacSHA256"));
